...
**A note on Wokwi:** given how much of your recent work has been simulation-first, worth knowing where that breaks down here — Wokwi's ESP32 simulation does not support Classic Bluetooth audio, so Phase 1 has to happen on real hardware. Phases 2–3 (display, WiFi, NTP, weather) *can* be prototyped in Wokwi first if you want to test that logic before your parts arrive.
...
1. Wire the PCM5102A to the I2S pins above, and its 3.5mm output to your speakers/headphone amp.
2. Install the libraries listed in section 4.
3. Flash this starting sketch:
...
void setup() {
  ...
  a2dp_sink.start("Desk DAC");  // this is the name your phone will see in Bluetooth settings
}
...
4. On your phone, open Bluetooth settings and pair with "Desk DAC" the same way you'd pair headphones. Play music — it should come out clean through your speakers.
